  ...
  return (
    ...
    <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card icon={<Zap className="w-8 h-8 text-green-600" />} title="Modelos IA gratuitos" detail="Utiliza OpenRouter con múltiples modelos de visión gratuitos que se alternan automáticamente según disponibilidad y saturación." />
